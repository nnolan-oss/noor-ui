...
export const Video = React.forwardRef<HTMLVideoElement, VideoProps>(
  (
    ...
    const videoClasses = twMerge(
      classNames(videoBase, {
    ...
    return (
      <div
        ...
        onMouseEnter={() => handleShowControl("enter")}
        onMouseLeave={() => handleShowControl("leave")}
      >
        <video
            ...
            >
              <div className="flex gap-2 items-center w-full">
                <IconButton
                  ...
                  icon={
                    isPlaying
                      ? pauseIcon || <TbPlayerPause />
                      : playIcon || <TbPlayerPlay />
                  }
                  onClick={handlePlayPause}
                />
                <IconButton
